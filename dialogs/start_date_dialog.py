...
class StartDateDialog(CancelAndHelpDialog):
    """Resolve the date"""
    ...
    def __init__(
        ...
        super(StartDateDialog, self).__init__(
            dialog_id or StartDateDialog.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client

        date_time_prompt = DateTimePrompt(
            DateTimePrompt.__name__, StartDateDialog.datetime_prompt_validator
        )
    ...
    async def initial_step(
        ...
        prompt_msg = "On what date would you like to go?"
        reprompt_msg = (
            "I'm sorry, for best results, please enter your going travel "
